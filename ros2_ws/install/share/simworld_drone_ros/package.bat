...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\simworld_drone_ros\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\simworld_drone_ros\hook\ament_prefix_path.bat"
