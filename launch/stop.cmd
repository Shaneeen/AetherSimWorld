...
powershell -NoProfile -ExecutionPolicy Bypass -Command "Get-CimInstance Win32_Process | Where-Object { $_.CommandLine -match 'simworld_drone_ros\.(bridge\.ue_bridge|duel\.target_brain|duel\.chaser_brain|team\.(coordinator|drone_controller)|watch\.chase_watch)' } | ForEach-Object { Stop-Process -Id $_.ProcessId -Force -ErrorAction SilentlyContinue }" >nul 2>nul
